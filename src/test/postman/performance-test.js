...
async function measurePerformance() {
    ...
    fs.writeFileSync(
        path.join(__dirname, '/results/performance-results.json'),
        JSON.stringify(results, null, 2)
    );
    
    console.log('\nPerformance test completed!');
    console.log('Results saved to postman/results/performance-results.json');
...
function generateMarkdownTable() {
    ...
    console.log('Markdown table saved to postman/PERFORMANCE_RESULTS.md');
}
